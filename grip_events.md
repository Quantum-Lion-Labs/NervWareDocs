...
## Main Events
The events follow Unity's lifecycle of events, see the [Unity execution order documentation](https://docs.unity3d.com/6000.3/Documentation/Manual/execution-order.html) if you are unfamiliar. The grip that is invoking these events is registered in `OnEnable` and `OnDisable`, and found in `OnAwake`.
